  ...
  private async getInvoiceDocument() {
    const documentObject = {
      content: [
                ...
                text: [
                  {
                    text:
                      ...
                      this.order.productDiscount > 0
                        ? `You Saved ${this.order.productDiscount} TK from digihaat.com`
                        : '',
                    bold: true,
                  },
                ],
        ...
        {
          text: 'Thank you for your order from www.digihaat.com',
          style: 'p',
          alignment: 'center',
          margin: [0, 10],
        },
